...
router.post('/produtos', ensureAdminAuthenticated, parseUpload(), produtoController.criar);
router.put('/produtos/:id', ensureAdminAuthenticated, parseUpload(), produtoController.atualizar);
